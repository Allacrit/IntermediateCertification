...
### Описание файла "Start.bat":

`python -m venv venv` - Запустит создание виртуального окружения.

`ppython -m pip install --upgrade pip ` - Обновит версию Pip.

`pip install colorama` - Установит библиотеку Colorama.

`python main.py` - Запустит файл программы "Заметки".
